...
- **The Protein:** 0.5 lbs Lean Ground Beef (90/10) or Ground Turkey
...
1.  **Clear the Deck:** Ensure the skillet is clean and all supplies are staged within reach of the heat source.
2.  **Rice Prep:** Massage the microwave rice pouch to break up grains while still sealed. Set aside.

### Phase 2: Engagement (The Cook)
1.  **High Heat Contact:** Set skillet to medium-high heat. Add the ground protein immediately.
...
2.  **Immediate Sanitation:** Run the pan under hot water while it’s still warm to prevent the sauce from "baking" onto the hardware.
...
If you want to see the **Checkboxes** work, go to the "Preview" tab. In GitHub, you can actually click those boxes to check them off as you gather your tools in the kitchen!

**Would you like me to provide the "Actual MD File Content" for the Chapter 2 Hardware specs next?**
